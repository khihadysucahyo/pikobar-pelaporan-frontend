  ...
  <div>
    ...
    >
      <v-row align="start">
        ...
        >
          <label>{{ $t('label.nasal_swab') }}</label>
        </v-col>
        <v-col
          cols="12"
          md="9"
      ...
      <v-row align="start">
        <v-col
          ...
          :class="{'py-0': $vuetify.breakpoint. smAndDown}"
        >
          <label>{{ $t('label.throat_swab') }}</label>
        </v-col>
        <v-col
          cols="12"
          md="9"
      ...
      <v-row align="start">
        <v-col
          ...
          :class="{'py-0': $vuetify.breakpoint. smAndDown}"
        >
          <label>{{ $t('label.nasopharyngeal_swab') }}</label>
        </v-col>
        <v-col
          cols="12"
          md="9"
      ...
      <v-row align="start">
        <v-col
          ...
          :class="{'py-0': $vuetify.breakpoint. smAndDown}"
        >
          <label>{{ $t('label.orofaringeal_swab') }}</label>
        </v-col>
        <v-col
          cols="12"
          md="9"
