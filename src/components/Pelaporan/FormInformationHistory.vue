        ...
        <v-row>
          ...
          >
            ...
            <ValidationProvider v-slot="{ errors }">
              ...
              <v-row v-for="rowIdx in Math.ceil(symptomOptions.length / 3)" :key="rowIdx">
                <v-col v-for="item in symptomOptions.slice(3 * (rowIdx - 1), 3 * rowIdx)" :key="item" class="one-third column">
                  <label class="material-checkbox-custom">
                    <input
