...
export default {
  ...
  label: {
    ...
    smoke: 'Merokok',
    consumption_of_alcoholic_drink: 'Konsumsi Minuman Beralkohol',
    income: 'Penghasilan',
    sedentary: 'Sedenter',
    more_physical_exercise: 'Latihan Fisik < 150 menit/minggu (3 x 50 menit/minggu atau 5 x 30 menit/minggu)',
    less_physical_exercise: 'Latihan Fisik > 150 menit/minggu (3 x 50 menit/minggu atau 5 x 30 menit/minggu)',
    ...
    country_visited: 'Negara yang dikunjungi',
    city_visited: 'Kota yang dikunjungi',
    date_of_departure: 'Tanggal Mulai Perjalanan',
    date_of_return: 'Tanggal Pulang Perjalanan',
    closely_contact_with_suspect_cases: 'Kontak Erat Dengan Kasus Suspek',
    enter_name_suspect_patient: 'Masukkan Nama Pasien Suspek',
    closely_contact_with_confirmed_cases: 'Kontak Erat Dengan Kasus Terkonfirmasi',
    visit_animal_market: 'Mengunjungi Pasar Hewan',
    visit_public_place: 'Mengunjungi Tempat Publik',
    visit_health_facility: 'Mengunjungi Fasilitas Kesehatan',
