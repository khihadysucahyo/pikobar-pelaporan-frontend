export default {
  ...
  RESET_FORM_PASIEN: (state) => {
    ...
    state.formPasien.diagnosis_ards = ''
    state.formPasien.diagnosis_covid = ''
    state.formPasien.diagnosis_pneumonia = ''
    ...
    state.formPasien.close_contact = ''
    state.formPasien.close_contact_confirm = ''
    state.formPasien.close_contact_animal_market = ''
    state.formPasien.close_contact_public_place = ''
    state.formPasien.close_contact_medical_facility = ''
    state.formPasien.close_contact_heavy_ispa_group = ''
    state.formPasien.close_contact_health_worker = ''
